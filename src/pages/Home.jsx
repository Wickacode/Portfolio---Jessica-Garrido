    ...
    <div className="home-container width-contain">
      <div className="home-elements">
        <div className="name-container">
          <h1>Jessica <br /> Garrido</h1>
        </div>
        <div className={`profile-pictures ${isActive ? 'grayscale-active' : ''}`}>
...
je suis à la recherche d'une entreprise pour y faire mon alternance en Concepcion d'applications web et mobiles. <br/>
Je vous remercie de votre présence sur mon site, et vous invite à le parcourir pour mieux me découvrir ! <br/>
